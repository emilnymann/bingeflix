...
import com.datamatiker.bingeflix.ui.profilesetup.ProfileSetupGenresFragment;
...
public class ProfileSetup extends AppCompatActivity {
    ...
    public void profileSetupPersonalContinue(View view) {
        FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
        ProfileSetupGenresFragment newFragment = ProfileSetupGenresFragment.newInstance();
        ft.replace(R.id.container, newFragment)
                .commitNow();
    }
}
